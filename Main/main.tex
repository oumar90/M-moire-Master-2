...
\usepackage{fancyhdr}
\parindent=0cm
%\usepackage{array}%c'est un packet permettant d'insérer un ta	bleau dans un document latex
...
\usepackage{float}
\usepackage{xcolor}
%Chargment de packages pour canvas de textes (bordures)
\usepackage{tcolorbox,bclogo,environ,wrapfig}
\usepackage{colortbl}  % pour les couleurs de fond de cellules
\usepackage{multirow}
\usepackage{caption}
\usepackage{comment}
\usepackage{csquotes}
...
\lhead{}
%\chead{\small{CONCEPTION ET DÉPLOIEMENT D'UN MODULE DE SIGNATURE ÉLECTRONIQUE BASÉ SUR LA PKI}}
...
%\graphicspath{{imgs/}} %char
\begin{document}
%\maketitle
%\frontmatter pour la classe book uniquement
